        ...
        <div data-aos="fade-up" className="div-projects">
            ...
            <div  className='row'>
                <div className="col 12 col-md-6  col-lg-4 d-flex justify-content-center">
                    <div onClick={goToCoco} className="card bg-dark text-white m-2" style={{ width: '25rem', height:"12rem",border: 'none' }}>
                ...
                <div className="col 12 col-md-6 col-lg-4 d-flex justify-content-center">
                    <div onClick={goToGit} className="card bg-dark text-white m-2" style={{ width: '25rem',height:"12rem", border: 'none' }}>
                        <img src="https://res.cloudinary.com/dbv6dgwez/image/upload/v1669635719/CV/coding_computer_tga7ki.jpg" className="card-img" alt="..." />
                        <div className="card-img-overlay">
                            <div className="glassCard">
                            <h5 className="card-title">Github projects</h5>
                ...
                <div className="col 12 col-md-6 col-lg-4 d-flex justify-content-center">
                    <div onClick={goToRick} className="card bg-dark text-white m-2" style={{ width: '25rem',height:"12rem", border: 'none' }}>
                ...
                <div className="col 12 col-md-6 col-lg-4 d-flex justify-content-center">
                    <div onClick={goToAllcot} className="card bg-dark text-white m-2" style={{ width: '25rem',height:"12rem", border: 'none' }}>
